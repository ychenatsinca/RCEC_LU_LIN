...
if (ld.create.nc) {
  ...
  dim3 <- ncdim_def("west_east","",  1:258, create_dimvar=FALSE) 
  dim4 <- ncdim_def("south_north","",1:369, create_dimvar=FALSE)
  dim5 <- ncdim_def("south_north_stag","",1:370, create_dimvar=FALSE)
  dim6 <- ncdim_def("west_east_stag","",1:259,   create_dimvar=FALSE) 
